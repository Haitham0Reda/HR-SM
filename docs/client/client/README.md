...
The HRMS frontend is a modern, multi-application architecture built with React 18+. It consists of two independent applications sharing a common component library, designed for enterprise-level HR management and platform administration.
