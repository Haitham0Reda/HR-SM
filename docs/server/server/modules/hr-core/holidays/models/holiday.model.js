...
const holidaySchema = new mongoose.Schema({
    // Organization identifier (location concept removed, using default org)
    location: {
        type: String,
...
// Static method to get or create holiday settings for location
holidaySchema.statics.getOrCreateForlocation = async function (locationId) {
    let settings = await this.findOne({ location: locationId });
