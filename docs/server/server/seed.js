...
const seedData = async () => {
    try {
        ...
        const holidays = await Holiday.create([
            {
                location: defaultorganization._id,
                officialHolidays: [
                    {
        ...
        const events = await Event.create([
            ...
            },
            {
                ...
                description: 'Hands-on workshop for technical department staff',
        ...
        const documents = await Document.create([
            ...
            },
            {
                ...
                description: 'Bachelor and Master certification certificates'
            },
            {
        ...
        const hardcopies = await Hardcopy.create([
            ...
            {
                title: 'business Certificates - technical department',
                description: 'Original business certificates for engineering staff',
                category: 'certificate',
                location: 'technical department - File Room, Shelf B',
        ...
        const leaves = []; /* await Leave.create([
            ...
            // Mission leave - pending
            {
                ...
                mission: {
                    location: 'Giza, Egypt',
                    purpose: 'AI research collaboration with Cairo company'
                },
                workflow: {
                    supervisorApprovalStatus: 'pending',
                    currentStep: 'supervisor-review'
        ...
        // Note: organization model has been removed from the system
