...
### organization Model Enum Values

The organization model has strict enum values. Always use:

```javascript
{
    organizationCode: 'BUS' | 'ENG' | 'CS',
    name: 'organization of Business' | 'organization of Engineering' | 'organization of information technology',
...
- **User**: requires `organization` (organization ObjectId)
...
2. Create all necessary related models (organization, User, etc.)
