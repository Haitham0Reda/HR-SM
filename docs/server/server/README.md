...
The HR-SM backend is a modern, enterprise-level multi-tenant SaaS platform built with Node.js, Express.js, and MongoDB. It features a modular plugin architecture, comprehensive tenant isolation, and dual-namespace API design for both tenant operations and platform administration.
...
│   │   ├── attendance/            # ✅ Attendance management (moved from legacy)
...
│   │   ├── backup/                # ✅ Backup operations (moved from legacy)
│   │   ├── holidays/              # ✅ Holiday management (moved from legacy)
│   │   ├── missions/              # ✅ Mission tracking (moved from legacy)
│   │   ├── overtime/              # ✅ Overtime management (moved from legacy)
│   │   ├── requests/              # ✅ Request management (moved from legacy)
│   │   ├── users/                 # ✅ User management (moved from legacy)
│   │   │   ├── controllers/       # User, department, position controllers
│   │   │   ├── models/            # User, department, position models
│   │   │   └── routes.js          # Merged user routes
│   │   ├── vacations/             # ✅ Vacation management (moved from legacy)
│   │   │   ├── controllers/       # Vacation controllers
│   │   │   ├── models/            # Vacation models
│   │   │   └── routes.js          # Merged vacation routes
...
│   ├── payroll/                   # ✅ Payroll module (moved from legacy)
│   ├── reports/                   # ✅ Reports module (moved from legacy)
│   ├── documents/                 # ✅ Documents module (moved from legacy)
│   ├── announcements/             # ✅ Announcements module (moved from legacy)
│   ├── surveys/                   # ✅ Surveys module (moved from legacy)
│   ├── notifications/             # ✅ Notifications module (moved from legacy)
│   ├── events/                    # ✅ Events module (moved from legacy)
│   ├── analytics/                 # ✅ Analytics module (moved from legacy)
│   ├── dashboard/                 # ✅ Dashboard module (moved from legacy)
│   └── theme/                     # ✅ Theme module (moved from legacy)
│
