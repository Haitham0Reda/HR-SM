...
import { getAllPolicies } from '../controller/mixedVacation.controller.js';
...
async function runTest() {
  try {
    console.log('Starting debug getAllPolicies test...');
    ...
    // Test the getAllPolicies controller function
    console.log('Testing getAllPolicies controller function...');
    const req = {
      query: {}
    };
    ...
    console.log('Called getAllPolicies');
