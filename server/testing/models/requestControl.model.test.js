...
describe('RequestControl Model', () => {
  ...
  it('should handle permission sub-type controls', async () => {
    ...
    control.permissionRequests.permissionTypes.lateArrival.enabled = false;
    control.permissionRequests.permissionTypes.lateArrival.disabledMessage = 'Late arrival disabled';
    await control.save();
