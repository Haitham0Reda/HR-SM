...
describe('Life Insurance Module - Integration Tests', () => {
    ...
    beforeAll(async () => {
        ...
        tenant1 = await Tenant.create({
            ...
            enabledModules: [{
                moduleId: MODULES.LIFE_INSURANCE,
                enabledAt: new Date(),
                enabledBy: 'system'
            }],
            config: {
        ...
        // Create test claim
        claim1 = await InsuranceClaim.create({
            policyId: policy1._id,
            employeeId: employeeUser1._id,
            tenantId: tenant1._id,
    ...
    afterAll(async () => {
        ...
        await InsuranceClaim.deleteMany({ tenantId: { $in: [tenant1._id, tenant2._id] } });
    ...
    describe('Middleware Integration', () => {
        ...
        test('should require module license for all endpoints', async () => {
            ...
            const tenantWithoutModule = await Tenant.create({
                ...
                enabledModules: [], // No life insurance module
                config: {}
            });
