    ...
    try {
        ...
        const surveys = await Survey.find({
            ...
            $or: [
                ...
                { 'assignedTo.departments': { $in: req.user.department ? [req.user.department] : [] } },
                { 'assignedTo.roles': { $in: req.user.role ? [req.user.role] : [] } },
                { 'assignedTo.specificEmployees': req.user._id }
            ]
        });
