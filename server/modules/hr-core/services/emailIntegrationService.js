...
class EmailIntegrationService {
  ...
  async sendOvertimeRequestNotification(tenantId, requestData, employee, approver) {
    const emailData = {
      to: approver.email,
      subject: `Overtime Request from ${employee.personalInfo?.firstName} ${employee.personalInfo?.lastName}`,
      template: 'overtimeRequest',
      variables: {
        approverName: `${approver.personalInfo?.firstName || approver.username}`,
